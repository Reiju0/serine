    ...
    @foreach($detail as $item)
        <form class="form-horizontal" enctype="multipart/form-data" id="user" onsubmit="return false;">
            ...
            <div class="form-group" align="center">
                <label style="padding: 0 0 15px;" class="white">Permission Name: <span id="permission_name" class="red">{{$item->permission}}</span></label>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                    <select class="form-control" name="module" required id="module">
                        {!! app(\App\Http\Controllers\Permission\PermissionController::class)->getModule($item->module) !!}
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                    <input type="text" name="permission" class="form-control" value="{{$permission}}" required placeholder="permission" id="permission">
                </div>
            </div>
            <div class="form-group" align="center">
